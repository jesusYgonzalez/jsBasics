...
class Player extends Person {
  constructor(name, job, age, position, nickname) {
    super(name, job, age);
    this.position = position;
    this.nickname = nickname;
    this.yearOfBirth = () => {
      const isAge = new Date().getFullYear();
      return isAge - age;
    };
  }
}

const player1 = new Player("bob", "soccer player", "32", "forward", "bolt");

// console.log(player1.name);
// console.log(player1.yearOfBirth());

// document.write(
//   `${player1.name} is a ${player1.job} that is ${
//     player1.age
//   } years of age. He is plays at the ${
//     player1.position
//   } position and his nickname is ${
//     player1.nickname
//   }! he was born in ${player1.yearOfBirth()}`
// );

// window.addEventListener("DOMContentLoaded", () => {
//   const form = document.getElementById("name").addEventListener("click", () => form.submit());
// });
//

const state = {
  player1: new Player("bob", "soccer player", "32", "forward", "bolt"),
  player2: new Player("joe", "soccer player", "31", "defense", "wall"),
  player3: new Player(
    "liam",
    "soccer player",
    "19",
    "midfield",
    "distributer-in-chief"
  )
};
console.table(state);
...
form.addEventListener("submit", event => {
  ...
  alert(
    `${form.name.value} is a ${player1.job} that is ${
      player1.age
    } years of age. He is plays at the ${
      player1.position
    } position and his nickname is ${
